...
const ContactUs: React.FC = () => {
    ...
    return (
        <div id="contactus" className="text-black p-1 min-h-fit relative sm:px-8 px-8">
            <div className="container mx-auto z-10 flex flex-wrap items-center justify-center max-w-7xl my-10 borderShadow"
            >
                {/* Left Side: Image */}
                ...
                <div className="w-full lg:w-1/2 bg-white rounded-lg p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* <button
                            ...
                            className="w-full bg-[#232428] text-white py-2 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        >
                            {isSubmitting ? 'Sending...' : 'Send Message'}
                        </button> */}
                    </form>
