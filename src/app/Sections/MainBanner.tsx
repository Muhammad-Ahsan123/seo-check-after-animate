                ...
                <div className="flex flex-col gap-4 lg:flex-row items-center justify-between px-4 md:px-16 lg:px-20 xl:px-40 lg:h-screen z-10">
                    ...
                    <div className="w-full lg:w-[55%] gap-6 text-center lg:text-left sm:mt-0 mt-4 font-sans animate-slideInLeft">
                        ...
                        <h2 className="text-xl sm:text-2xl font-semibold inline-block py-1 text-white">
                            Expertise in Ai Solution, Cross Platform Mobile Apps, Data Engineering, Web Interfaces
                        </h2>
                        <p className="text-sm font-normal sm:font-semibold leading-5 sm:leading-6 tracking-wider text-gray-100 sm:text-sm md:text-base">
                            SYSLAB.AI (Private) Limited focuses on providing and developing innovative Artificially
                            Intelligent (AI) solutions. Our motto is that technology and innovation should be explored
                            to develop efficient and effective solutions. With a team of dedicated and talented
                            professionals, developers, and scientists, we strive to deliver efficient solutions to B2B
                            as well as B2C market. Inspired by the emerging technologies such as Deep Learning,
                            Natural Language Processing, Computer Vision, Generative AI, IoTs, and Blockchain, we are
                            developing and enriching solutions that can be beneficial for the industry. For details,
